    ...
    <div
      ...
      <div
        ...
        className={cn(
          ...
          // Adjust the padding for floating and inset variants. Collapsed-icon
          // mode drops this padding — SidebarHeader/Group/Footer each already
          // apply their own p-2, so stacking both here left too little room
          // for the icon-sized buttons and made them overflow unevenly.
